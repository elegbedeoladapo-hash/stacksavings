      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "28px" }}>
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => setFormData({ ...formData, primaryUseCase: e.target.value as AuditFormData["primaryUseCase"] })}
            style={selectStyle}
          >
            <option value="coding" style={{ background: "#1e293b" }}>Coding</option>
            <option value="writing" style={{ background: "#1e293b" }}>Writing</option>
            <option value="data" style={{ background: "#1e293b" }}>Data Analysis</option>
            <option value="research" style={{ background: "#1e293b" }}>Research</option>
